...
const INBOUND_PERMISSION = {
  ...
  "browser.screencast.subscribe.request": "workspace.read",
  "browser.screencast.unsubscribe.request": "workspace.read",
  "browser.tab.execute.request": "workspace.write",
  "browser.tabs.announce.request": "workspace.read",
...
const OUTBOUND_PERMISSION = {
  ...
  "browser.screencast.subscribe.response": "workspace.read",
  "browser.tab.execute.response": "workspace.write",
  "browser.tabs.changed": "workspace.read",
